...
sudo rpm-ostree install aircrack-ng android-tools btop clang darkman duperemove gamescope git-lfs gnome-console haveged htop inxi iucode-tool iwd mosh mpv neovim nmap pipx pre-commit qrencode rng-tools setroubleshoot sshguard steam-devices symlinks syncthing terminus-fonts-console tmux tor torsocks unbound zsh
